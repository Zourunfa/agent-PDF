...
import { UserOutlined, LockOutlined, ArrowLeftOutlined, CheckCircleOutlined, MailOutlined } from '@ant-design/icons';
        ...
        <div style={{ width: '100%', maxWidth: 440 }}>
          <div style={{
            ...
            <p style={{ fontSize: 14, color: '#6B7280', margin: 0, marginBottom: 8 }}>
              我们已向 <span style={{ fontWeight: 600, color: '#1E1B4B' }}>{formData.email}</span> 发送了验证邮件
            </p>
            <p style={{ fontSize: 13, color: '#9CA3AF', margin: 0, marginBottom: 4 }}>
              请检查邮箱并点击验证链接激活账户
            </p>
            <p style={{ fontSize: 12, color: '#D1D5DB', margin: 0, paddingTop: 8 }}>
              页面将在 3 秒后自动跳转到登录页...
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ padding: '32px' }}>
            ...
            >
              ...
              <div style={{ fontSize: 11, color: '#9CA3AF', marginTop: -8, marginBottom: 16, marginLeft: 2 }}>
                至少8位，包含字母和数字
              </div>
